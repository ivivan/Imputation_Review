...
def test_qld_single_station():
    ...
    x_train = x_train[:3820]
    y_train = y_train[:3820]
    x_test = x_test[:940]
    y_test = y_test[:940]
    x_train_len = x_train_len[:3820]
    x_train_before_len = x_train_before_len[:3820]
    x_test_len = x_test_len[:940]
    x_test_before_len = x_test_before_len[:940]

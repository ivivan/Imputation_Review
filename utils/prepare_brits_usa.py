...
def preprocess_df(df):
    ...
    scaler_x.fit(do['nitrate_con'].values.reshape(-1, 1))
    do['nitrate_con'] = scaler_x.transform(do['nitrate_con'].values.reshape(
        -1, 1))
    ...
    df_train_one = do.loc['2016-01-01T00:00':'2016-09-30T23:00'].copy()
    df_test_one = do.loc['2016-10-01T00:00':'2016-12-31T23:00'].copy()
...
if __name__ == "__main__":
    ...
    with open('USA_nitrate_2train1012.json', 'w') as fp:
        fp.write('\n'.join(json.dumps(i) for i in sample_list_train))
    with open('USA_nitrate_2test1012.json', 'w') as fp:

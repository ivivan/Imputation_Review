...
def preprocessdf(df):
    ...
    df = df.loc['2016-10-01T00:00':'2016-12-31T23:00'].copy()

    ## data clean, for short period of time
    df.loc['2016-10-01T00:00':'2016-12-31T23:00', :] = df.loc['2016-10-01T00:00':'2016-12-31T23:00', :].fillna(method='ffill')
...
if __name__ == "__main__":
    ...
    # for i in range(12):
        ...
        target_column = complete_middle['nitrate_con'].values.copy()
